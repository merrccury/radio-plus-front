...
const submitSignUpForm = (props) => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className={style.form}>
            <Field name="firstName" placeholder="First Name" type="text" validate={text} component={renderField} label="First Name"/>
            <Field name="lastName" placeholder="Last Name" type="text" validate={text} component={renderField} label="Last Name"/>
            <Field name="email" placeholder="Email" type="email" validate={email} component={renderField} label="Email"/>
            <Field name="password" type="password" placeholder="Password" validate={password} component={renderField} label="Password"/>
            <Field name="repeatPassword" placeholder="Repeat password" type="password" validate={password} component={renderField} label="Repeat password"/>
